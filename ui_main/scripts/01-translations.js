...
const translations = {
  en: {
    ...
    smartHow2: 'AI automatically improves your text',
    smartHow3: 'Polished text gets pasted — done!',
    ...
    // About
    aboutTagline: 'Voice to text, instantly.',
  ...
  de: {
    ...
    smartHow2: 'KI verbessert deinen Text automatisch',
    smartHow3: 'Verbesserter Text wird eingefügt — fertig!',
    ...
    // About
    aboutTagline: 'Sprache zu Text, sofort.',
    ...
    'palette.cmd.navReplacements': 'Zu Textersetzungen',
