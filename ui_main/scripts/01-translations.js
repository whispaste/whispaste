...
const translations = {
  en: {
    ...
    descNotifyBg: 'Show notification when app starts in background',
    ...
    descNotifyDonate: 'Occasional reminder to support WhisPaste development',
    labelTheme: 'Theme',
    themeSystem: 'System',
    themeLight: 'Light',
    themeDark: 'Dark',
  ...
  de: {
    ...
    descNotifyBg: 'Benachrichtigung anzeigen, wenn die App im Hintergrund startet',
    ...
    descNotifyDonate: 'Gelegentliche Erinnerung zur Unterstützung der WhisPaste-Entwicklung',
