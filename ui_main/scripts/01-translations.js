...
const translations = {
  en: {
    ...
    'onboarding.smart_llm_hint': 'Choose an offline AI model for Smart Mode — you can download it later in Settings.',
    ...
    smartLlmSelected: 'Active',
    smartLlmSelect: 'Set as active',
  ...
  de: {
    ...
    'onboarding.smart_llm_hint': 'Wähle ein Offline-KI-Modell für den Smart-Modus — du kannst es später in den Einstellungen herunterladen.',
    'onboarding.smart_llm_smollm2': 'SmolLM2',
    ...
    smartLlmSelected: 'Aktiv',
    smartLlmSelect: 'Als aktiv setzen',
    smartLlmModelSmollm2: 'SmolLM2',
