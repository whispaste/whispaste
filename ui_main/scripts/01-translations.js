...
const translations = {
  en: {
    ...
    labelUseVAD: 'Enable VAD',
    descUseVAD: 'Use AI-based voice detection to remove silence — more accurate than simple threshold trimming',
  ...
  de: {
    ...
    smartCleanupDesc: 'Korrigiert Grammatik, Rechtschreibung und Zeichensetzung — Inhalt und Länge bleiben unverändert',
    smartConcise: 'Straffen',
    smartConciseDesc: 'Strafft deinen Text um 30–40 % — entfernt Füllwörter und Redundanz, behält alle Informationen',
    smartEmail: 'E-Mail',
    ...
    smartSummaryDesc: 'Fasst deinen Text in 2–4 Kernsätzen zusammen — extrahiert nur das Wesentliche',
    smartNotes: 'Notizen',
    ...
    'palette.hint': 'Drücke Ctrl+K zum Öffnen',
