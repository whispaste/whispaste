...
const translations = {
  en: {
    ...
    smartConciseDesc: 'Cuts redundancy and filler words — same message, fewer words',
    smartEmail: 'Email',
    ...
    smartSummaryDesc: 'Extracts key points as a brief prose summary — details are dropped',
    smartNotes: 'Notes',
  ...
  de: {
    ...
    smartConciseDesc: 'Streicht Redundanz und Füllwörter — gleiche Aussage, weniger Worte',
    smartEmail: 'E-Mail',
    ...
    smartSummaryDesc: 'Destilliert auf die Kernpunkte als kurze Zusammenfassung — Details entfallen',
    smartNotes: 'Notizen',
