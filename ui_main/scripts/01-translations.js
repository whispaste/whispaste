...
const translations = {
  en: {
    ...
    smartCleanupDesc: 'Fixes grammar, spelling, and punctuation — your text stays the same, just error-free',
    smartConcise: 'Concise',
    smartConciseDesc: 'Shortens your text by cutting redundancy and filler — same meaning, fewer words',
    smartEmail: 'Email',
    ...
    smartSummaryDesc: 'Distills your speech down to just the key points in a few sentences',
    smartNotes: 'Notes',
    smartNotesDesc: 'Flexible notes with headings and bullet points — for quick personal reference',
    ...
    'palette.cmd.presetConcise': 'Preset: Make Concise',
  ...
  de: {
    ...
    smartCleanupDesc: 'Korrigiert Grammatik, Rechtschreibung und Zeichensetzung — dein Text bleibt gleich, nur fehlerfrei',
    smartConcise: 'Kompakt',
    smartConciseDesc: 'Kürzt deinen Text durch Streichen von Redundanz und Füllwörtern — gleiche Aussage, weniger Worte',
    smartEmail: 'E-Mail',
    ...
    smartSummaryDesc: 'Destilliert deine Sprache auf die Kernpunkte in wenigen Sätzen',
    smartNotes: 'Notizen',
    smartNotesDesc: 'Flexible Notizen mit Überschriften und Stichpunkten — als schnelle persönliche Referenz',
    ...
    'palette.cmd.presetConcise': 'Preset: Kompakt',
