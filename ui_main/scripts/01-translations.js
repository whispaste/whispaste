...
const translations = {
  en: {
    ...
    'onboarding.smart_note': 'A local or cloud AI model will be used automatically — no extra setup needed.',
  ...
  de: {
    ...
    'onboarding.smart_note': 'Ein lokales oder Cloud-KI-Modell wird automatisch verwendet — keine zusätzliche Einrichtung nötig.',
