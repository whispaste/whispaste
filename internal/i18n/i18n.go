...
var translations = map[string]map[string]string{
	"en": {
		...
		"preflight.summary.pass":                  "Ready for local transcription.",
		"preflight.summary.pass_download":         "Ready to download and use local transcription.",
		"preflight.summary.warn":                  "Local transcription may be slower on this device.",
		"preflight.summary.fail":                  "This device cannot run local transcription.",
		...
		"preflight.reason.avx":                    "Your CPU does not support the required instruction set (AVX).",
		"preflight.reason.avx2":                   "AVX2 is missing — local transcription may work, but performance is limited.",
		...
		"preflight.check.runtime":                 "Local engine runtime",
		"preflight.detail.os.fail":                "WhisPaste local transcription is currently available on Windows only.",
		"preflight.detail.arch.fail":              "The local transcription engine requires a 64-bit x86 system.",
		"preflight.detail.avx.fail":               "The local transcription engine requires AVX CPU instructions to run.",
		"preflight.detail.avx2.warn":              "AVX2 is missing. Transcription may still work, but slower notebooks will have less margin.",
		"preflight.detail.cores.warn":             "Fewer than four CPU cores can make local transcription feel sluggish during longer dictations.",
		"preflight.detail.memory.fail":            "At least 4 GB RAM is required for reliable local transcription.",
	...
	"de": {
		...
		"preflight.summary.pass":                  "Bereit für lokale Transkription.",
		"preflight.summary.pass_download":         "Bereit für Download und lokale Transkription.",
		"preflight.summary.warn":                  "Lokale Transkription kann auf diesem Gerät langsamer sein.",
		"preflight.summary.fail":                  "Dieses Gerät kann keine lokale Transkription ausführen.",
		...
		"preflight.reason.avx":                    "Die CPU unterstützt den benötigten Befehlssatz (AVX) nicht.",
		"preflight.reason.avx2":                   "AVX2 fehlt — lokale Transkription kann funktionieren, aber die Leistung ist eingeschränkt.",
		...
		"preflight.check.runtime":                 "Lokale Engine-Laufzeit",
		"preflight.detail.os.fail":                "WhisPaste-Lokaltranskription ist aktuell nur unter Windows verfügbar.",
		"preflight.detail.arch.fail":              "Die lokale Transkriptions-Engine erfordert ein 64-Bit-x86-System.",
		"preflight.detail.avx.fail":               "Die lokale Transkriptions-Engine benötigt AVX-CPU-Befehle zum Starten.",
		"preflight.detail.avx2.warn":              "AVX2 fehlt. Transkription kann trotzdem funktionieren, aber langsamere Notebooks haben weniger Reserve.",
		"preflight.detail.cores.warn":             "Weniger als vier CPU-Kerne können lokale Transkription bei längeren Diktaten träge machen.",
		"preflight.detail.memory.fail":            "Für zuverlässige lokale Transkription werden mindestens 4 GB RAM benötigt.",
