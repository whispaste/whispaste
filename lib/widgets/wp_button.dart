...
class _WpButtonPalette {
  ...
  static const _dark = _WpButtonPalette(
    disabledContent: WpColorsDark.textMuted,
    disabledFill: WpColorsDark.surfaceVariant,
    disabledBorder: WpColorsDark.borderSubtle,
    focusRing: WpColorsDark.textPrimary,
    accent: _WpButtonToneColors(
      fill: WpColorsDark.accent,
      // The theme's `onPrimary` — deep navy on cyan, ~11:1. Several call sites
      // hand-set white here today, which is ~1.9:1 on this accent.
      onFill: WpColorsDark.background,
      content: WpColorsDark.accent,
      border: WpColorsDark.borderSubtle,
      hoverWash: WpColorsDark.accentRowHover,
      pressedWash: WpColorsDark.accentActiveFill,
    ),
    neutral: _WpButtonToneColors(
      ...
      fill: WpColorsDark.active,
      onFill: WpColorsDark.textPrimary,
      content: WpColorsDark.textSecondary,
      border: WpColorsDark.borderSubtle,
      hoverWash: WpColorsDark.mutedRowHover,
      pressedWash: WpColorsDark.mutedActiveFill,
    ),
    danger: _WpButtonToneColors(
      fill: WpColorsDark.error,
      onFill: WpColorsDark.background,
      content: WpColorsDark.error,
      border: WpColorsDark.errorBorder30,
      hoverWash: WpColorsDark.errorRowHover,
      pressedWash: WpColorsDark.errorActiveFill,
    ),
  );

  static const _light = _WpButtonPalette(
    disabledContent: WpColorsLight.textMuted,
    disabledFill: WpColorsLight.surfaceVariant,
    disabledBorder: WpColorsLight.borderSubtle,
    focusRing: WpColorsLight.textPrimary,
    accent: _WpButtonToneColors(
      fill: WpColorsLight.accent,
      onFill: Color(0xFFFFFFFF),
      content: WpColorsLight.accent,
      border: WpColorsLight.borderSubtle,
      hoverWash: WpColorsLight.accentRowHover,
      pressedWash: WpColorsLight.accentActiveFill,
    ),
    neutral: _WpButtonToneColors(
      fill: WpColorsLight.active,
      onFill: WpColorsLight.textPrimary,
      content: WpColorsLight.textSecondary,
      border: WpColorsLight.borderSubtle,
      hoverWash: WpColorsLight.mutedRowHover,
      pressedWash: WpColorsLight.mutedActiveFill,
    ),
    danger: _WpButtonToneColors(
      fill: WpColorsLight.error,
      onFill: Color(0xFFFFFFFF),
      content: WpColorsLight.error,
      border: WpColorsLight.errorBorder30,
      hoverWash: WpColorsLight.errorRowHover,
      pressedWash: WpColorsLight.errorActiveFill,
    ),
  );
