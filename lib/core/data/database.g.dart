...
class $AutomationsTable extends Automations
    with TableInfo<$AutomationsTable, Automation> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AutomationsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'automations';
  @override
  VerificationContext validateIntegrity(
    Insertable<Automation> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Automation map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return Automation(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $AutomationsTable createAlias(String alias) {
    return $AutomationsTable(attachedDatabase, alias);
  }
}

class Automation extends DataClass implements Insertable<Automation> {
  final String id;
  final String trigger;
  ...
  AutomationsCompanion toCompanion(bool nullToAbsent) {
    return AutomationsCompanion(
      id: Value(id),
      trigger: Value(trigger),
  ...
  Automation copyWithCompanion(AutomationsCompanion data) {
    return Automation(
      id: data.id.present ? data.id.value : this.id,
      trigger: data.trigger.present ? data.trigger.value : this.trigger,
  ...
  @override
  String toString() {
    return (StringBuffer('Automation(')
          ..write('id: $id, ')
          ..write('trigger: $trigger, ')
  ...
  @override
  int get hashCode => Object.hash(id, trigger, actionType, payload, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Automation &&
...
class AutomationsCompanion extends UpdateCompanion<Automation> {
  final Value<String> id;
  final Value<String> trigger;
  ...
  AutomationsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       payload = Value(payload),
       createdAt = Value(createdAt);
  static Insertable<Automation> custom({
    Expression<String>? id,
    Expression<String>? trigger,
  ...
  @override
  String toString() {
    return (StringBuffer('AutomationsCompanion(')
          ..write('id: $id, ')
          ..write('trigger: $trigger, ')
          ..write('actionType: $actionType, ')
          ..write('payload: $payload, ')
...
typedef $$HotkeyLatencyEntriesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$AutomationsTableCreateCompanionBuilder =
    AutomationsCompanion Function({
      required String id,
      required String trigger,
      required String actionType,
      required String payload,
...
typedef $$AutomationsTableUpdateCompanionBuilder =
    AutomationsCompanion Function({
      Value<String> id,
      Value<String> trigger,
      Value<String> actionType,
...
class $$AutomationsTableFilterComposer
    extends Composer<_$HistoryDatabase, $AutomationsTable> {
  $$AutomationsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AutomationsTableOrderingComposer
    extends Composer<_$HistoryDatabase, $AutomationsTable> {
  $$AutomationsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AutomationsTableAnnotationComposer
    extends Composer<_$HistoryDatabase, $AutomationsTable> {
  $$AutomationsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AutomationsTableTableManager
    extends
        RootTableManager<
          _$HistoryDatabase,
          $AutomationsTable,
          ...
          $$AutomationsTableOrderingComposer,
          $$AutomationsTableAnnotationComposer,
          $$AutomationsTableCreateCompanionBuilder,
          $$AutomationsTableUpdateCompanionBuilder,
          (
            Automation,
            BaseReferences<_$HistoryDatabase, $AutomationsTable, Automation>,
          ),
          Automation,
          PrefetchHooks Function()
        > {
  $$AutomationsTableTableManager(_$HistoryDatabase db, $AutomationsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$AutomationsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AutomationsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$AutomationsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> trigger = const Value.absent(),
...
typedef $$AutomationsTableProcessedTableManager =
    ProcessedTableManager<
      _$HistoryDatabase,
      $AutomationsTable,
      Automation,
