...
List<SidePanelRow> filterSidePanelRows(List<SidePanelRow> rows, String query) {
  ...
  // ⚡ Bolt: Use a precompiled RegExp instead of calling String.toLowerCase()
  // on every title and subtitle inside the tight loop. This vastly improves
  // memory efficiency and reduces garbage collection pauses on large datasets
  // by completely avoiding thousands of intermediate string allocations.
