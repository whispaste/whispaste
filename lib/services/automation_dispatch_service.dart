...
/// control over. Applied to both the finished transcript and every
/// automation's trigger phrase before comparing them — only the
/// *comparison* is normalized, the transcript that eventually reaches
/// history/paste is never touched by this.
