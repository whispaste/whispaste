...
namespace {
// WhisPaste EdDSA (Ed25519) public key, base64. Identical to SUPublicEDKey in
// macos/Runner/Info.plist, so one signed appcast verifies on both platforms.
// WinSparkle 0.9.x uses it to verify sparkle:edSignature. Public value, no secret.
constexpr const char* kWhisPasteEdDSAPublicKey =
    "Ek8FS/co3CPMeZt7ss9XMDkga7jIG6RWNWbefZhtRck=";
