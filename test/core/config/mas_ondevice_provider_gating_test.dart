...
/// exists solely to gate simulated-keystroke Auto-Paste — it must never grow
/// a branch that excludes or defaults away from the onDevice STT provider.
/// These tests fail loudly if that changes.
void main() {
  group('MAS build gating — onDevice STT provider', () {
    ...
    test('no source file outside the Auto-Paste allowlist references the '
      ...
      // These files legitimately branch on the MAS flag — exclusively for
      // simulated-keystroke Auto-Paste (App Review Guideline 2.4.5 /
      // App Sandbox), never for STT provider selection.
