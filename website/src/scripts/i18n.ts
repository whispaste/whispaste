...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'explainer.whisperDesktop.seoDescription': 'Run OpenAI Whisper as a desktop voice-input tool on Windows, macOS and Linux: no Python, no cloud account. WhisPaste bundles whisper.cpp and pastes at your cursor.',
  ...
  de: {
    ...
    'explainer.whisperDesktop.seoDescription': 'OpenAI Whisper als Desktop-Sprach-Eingabe-Tool für Windows, macOS und Linux: ohne Python, ohne Cloud-Account. WhisPaste bündelt whisper.cpp, Transkript am Cursor.',
    ...
    'explainer.offlineStt.breadcrumb': 'Offline-Speech-to-Text',
    'explainer.offlineStt.seoTitle': 'WhisPaste Offline-Speech-to-Text für Windows, macOS und Linux',
