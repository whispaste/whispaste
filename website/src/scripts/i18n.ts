export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'screenshots.title': 'This is what WhisPaste looks like',
    'screenshots.desc': 'Real app views — workspace, detail editor, voice shortcuts, hotkey setup, and stats.',
    'screenshots.seeAll': 'See all screenshots →',
    'screenshots.workspace': 'Workspace',
    'screenshots.detail': 'Detail editor',
    'screenshots.shortcuts': 'Voice shortcuts',
    'screenshots.hotkey': 'Hotkey setup',
    'screenshots.insights': 'Stats',
    'gallery.title': 'See WhisPaste in action',
    'gallery.desc': 'Five real screens — workspace, detail editor, voice shortcuts, settings, and analytics. Switch between dark and light theme.',
    'gallery.themeDark': 'Dark',
    'gallery.themeLight': 'Light',
    'gallery.workspace': 'Workspace',
    'gallery.detail': 'Detail editor',
    'gallery.shortcuts': 'Voice shortcuts',
    'gallery.settings': 'Settings',
    'gallery.analytics': 'Analytics',
    'gallery.cta': 'Download WhisPaste',
    'privacy.label': 'Trust',
  ...
  de: {
    ...
    'gallery.title': 'WhisPaste in Aktion',
    'gallery.desc': 'Fünf echte Ansichten — Workspace, Detail-Editor, Sprach-Shortcuts, Einstellungen und Statistiken. Wechsle zwischen dunklem und hellem Design.',
    'gallery.themeDark': 'Dunkel',
    'gallery.themeLight': 'Hell',
    'gallery.workspace': 'Workspace',
    'gallery.detail': 'Detail-Editor',
    'gallery.shortcuts': 'Sprach-Shortcuts',
    'gallery.settings': 'Einstellungen',
    'gallery.analytics': 'Statistiken',
    'gallery.cta': 'WhisPaste herunterladen',
