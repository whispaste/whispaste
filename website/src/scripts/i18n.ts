export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'hero.title2': 'Done.',
    'hero.desc': 'WhisPaste turns your voice into text right where your cursor is — fully offline or with the cloud provider you choose. No subscription.',
    ...
    'pricing.title': 'All features. No subscription.',
    'pricing.desc': 'Every feature is included, always. Get it from the Store to support the project, or download free from GitHub.',
    'pricing.forever': 'MIT licensed — every feature for everyone',
    'pricing.feature.offline': 'Offline transcription',
    'pricing.feature.snippets': 'Voice Snippets',
    'pricing.feature.smartmode': 'GPU acceleration',
    ...
    'faq.free.a': 'Yes. WhisPaste is open source under the MIT license — all features are included, always. You can download it free from GitHub. The Microsoft Store version includes automatic updates and supports the project financially.',
    ...
    'changelog.1.1.3.highlight.0': 'Redesigned dashboard, Smart Mode, and Voice Snippets screens with cleaner layout',
    'changelog.1.1.3.highlight.1': 'Smart Mode and Voice Snippets now have separate AI provider settings',
  ...
  de: {
    ...
    'hero.title2': 'Fertig.',
    'hero.desc': 'WhisPaste macht aus deiner Stimme Text — genau dort, wo dein Cursor steht. Komplett offline oder mit dem Cloud-Anbieter deiner Wahl. Ohne Abo.',
    ...
    'pricing.label': 'Preis',
    'pricing.price': 'Open Source',
    'pricing.title': 'Alle Features. Kein Abo.',
    'pricing.desc': 'Jede Funktion ist enthalten, immer. Hol dir WhisPaste aus dem Store und unterstütze das Projekt, oder lade es kostenlos von GitHub.',
    'pricing.forever': 'MIT-lizenziert — alle Features für alle',
    'pricing.feature.offline': 'Offline-Transkription',
    'pricing.feature.snippets': 'Sprach-Snippets',
    'pricing.feature.smartmode': 'GPU-Beschleunigung',
    ...
    'faq.free.a': 'Ja. WhisPaste ist Open Source unter der MIT-Lizenz — alle Funktionen sind enthalten, immer. Du kannst es kostenlos von GitHub herunterladen. Die Microsoft-Store-Version bringt automatische Updates und unterstützt das Projekt finanziell.',
    ...
    'changelog.1.1.3.highlight.0': 'Dashboard, Smart Mode und Sprach-Snippets mit aufgeräumterem Layout überarbeitet',
    'changelog.1.1.3.highlight.1': 'Smart Mode und Sprach-Snippets haben jetzt getrennte KI-Anbieter-Einstellungen',
