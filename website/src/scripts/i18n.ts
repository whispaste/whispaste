...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'meta.description.default': 'Desktop voice-input tool — turn your voice into text right at the cursor, offline or with cloud providers. Free & open source for Windows & macOS.',
    ...
    'meta.title.download': 'Download WhisPaste — voice input for Windows & macOS',
    'meta.description.download': 'Download WhisPaste for Windows and macOS — via Microsoft Store, DMG, or free on GitHub. Offline-first voice input, no account, no subscription.',
    'meta.title.privacy': 'Privacy Policy — WhisPaste',
    'meta.description.privacy': 'Privacy Policy for the WhisPaste desktop app: how it handles your data — offline by default, no account, transcripts stay on your machine, only anonymous self-hosted opt-out usage stats.',
    'meta.title.screenshots': 'Screenshots — WhisPaste desktop voice input',
    'meta.description.screenshots': 'See WhisPaste in action — workspace, detail editor, Voice Snippets, settings, and analytics in light and dark theme. Desktop voice input for Windows & macOS.',
    ...
    'schema.app.description': 'Desktop voice-input tool that brings your voice into any app as text — offline by default, private, free & open source for Windows and macOS.',
    ...
    'hero.meta': 'Windows · macOS · Linux · Free & open source',
    ...
    'privacy.desc': 'Local when you want it. Cloud only when you choose it. Audio and text stay yours — usage stats are anonymous, self-hosted, and can be switched off.',
    ...
    'privacy.telemetry.desc': 'Usage stats are anonymous, aggregate and self-hosted — never your audio, text or history. Turn them (and crash reports) off any time in Settings → Privacy.',
    ...
    'features.privacy.desc': 'Stay local with built-in speech recognition or choose cloud on purpose. Audio and text stay on your device — anonymous usage stats are self-hosted and can be switched off.',
    ...
    'faq.windows.a': 'WhisPaste ships ready-to-run installers for Windows and macOS. On Linux, you can build WhisPaste from source — the Flutter codebase targets all three platforms. See the Download page for a short step-by-step guide.',
    ...
    'sponsor.desc': 'WhisPaste is free and open source — no ads, no profiling. Your support helps keep it that way.',
    ...
    'footer.tagline': 'Your voice becomes text — right where your cursor is, in any app.',
    ...
    'download.linux.title': 'Linux — Build from Source',
    'download.linux.desc': 'No pre-built binary yet. Build WhisPaste from source in a few steps — Flutter makes it straightforward.',
    ...
    'useCase.rsi.seoDescription': 'For knowledge workers with RSI: make text by speaking instead of typing, in any app, without leaving your workflow. Local-first desktop voice input.',
    ...
    'useCase.support.seoDescription': 'For helpdesk and support staff: answer tickets faster by speaking the reply straight into the ticket UI — no app switch, no copy-paste. Local-first.',
    ...
    'explainer.whisperDesktop.seoDescription': 'Run OpenAI Whisper as a desktop voice-input tool on Windows and macOS — no Python, no cloud account. WhisPaste bundles whisper.cpp and pastes at your cursor.',
  ...
  de: {
    ...
    'meta.description.privacy': 'Datenschutzerklärung für WhisPaste — wie Website und Desktop-App mit deinen Daten umgehen: offline als Standard, kein Account, Transkripte bleiben lokal, nur anonyme, self-hosted, abschaltbare Nutzungsstatistik.',
    ...
    'hero.meta': 'Windows · macOS · Linux · Kostenlos & Open Source',
    'hero.trust.anywhere': 'Open Source',
    'hero.trust.private': 'Privacy-first',
    ...
    'privacy.desc': 'Lokal, wenn du willst. Cloud nur, wenn du sie auswählst. Audio und Text bleiben bei dir — die Nutzungsstatistik ist anonym, self-hosted und abschaltbar.',
    ...
    'privacy.telemetry.desc': 'Die Nutzungsstatistik ist anonym, aggregiert und self-hosted — niemals dein Audio, Text oder Verlauf. In Einstellungen → Datenschutz jederzeit abschaltbar (auch Absturzberichte).',
    ...
    'features.privacy.desc': 'Lokale Spracherkennung eingebaut — oder Cloud nach Wahl. Audio und Text bleiben auf deinem Gerät — anonyme Nutzungsstatistik ist self-hosted und abschaltbar.',
    'pricing.label': 'Preis',
    'pricing.price': 'Open Source',
    ...
    'faq.windows.a': 'WhisPaste liefert fertige Installer für Windows und macOS. Unter Linux lässt sich WhisPaste aus dem Quellcode bauen — das Flutter-Projekt unterstützt alle drei Plattformen. Eine kurze Schritt-für-Schritt-Anleitung findest du auf der Download-Seite.',
    ...
    'download.linux.title': 'Linux — Aus Quellcode bauen',
    'download.linux.desc': 'Noch kein fertiger Download. WhisPaste lässt sich in wenigen Schritten aus dem Quellcode bauen — mit Flutter geht das schnell.',
    ...
    'sponsor.desc': 'WhisPaste ist kostenlos und Open Source — keine Werbung, kein Profiling. Deine Unterstützung hilft, dass das so bleibt.',
    'sponsor.github.title': 'GitHub Sponsors',
    ...
    'footer.author': 'silvio-lindstedt.de',
    'footer.tagline': 'Deine Stimme wird Text — genau dort, wo dein Cursor steht, in jeder App.',
    ...
    'useCase.rsi.seoDescription': 'Für Wissensarbeitende mit RSI: Text per Stimme produzieren statt zu tippen — in jeder App, ohne den Workflow zu verlassen. Offline-first Spracheingabe.',
    ...
    'useCase.support.seoDescription': 'Für Helpdesk und Kundensupport: Tickets schneller beantworten, indem du die Antwort direkt ins Ticket-UI sprichst — ohne App-Wechsel, ohne Copy-Paste.',
    ...
    'explainer.whisperDesktop.seoDescription': 'OpenAI Whisper als Desktop-Sprach-Eingabe-Tool für Windows und macOS — ohne Python, ohne Cloud-Account. WhisPaste bündelt whisper.cpp, Transkript am Cursor.',
    ...
    'explainer.offlineStt.seoDescription': 'Offline-Speech-to-Text auf dem Desktop: wie der lokale Whisper-Modus funktioniert, was er kann und was nicht und welches RAM-/CPU-Profil du brauchst.',
