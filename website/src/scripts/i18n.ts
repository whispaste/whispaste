export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'download.title': 'Your download is starting…',
    'download.subtitle': 'WhisPaste Setup will download automatically.',
    'download.manual': 'Download didn\'t start?',
    'download.manualLink': 'Click here to download manually',
    'download.smartscreen.title': 'Windows may show a warning',
    'download.smartscreen.desc': 'This is normal for new open-source software. Here\'s how to proceed:',
  ...
  de: {
    ...
    'download.title': 'Dein Download startet…',
    'download.subtitle': 'WhisPaste Setup wird automatisch heruntergeladen.',
    'download.manual': 'Download nicht gestartet?',
    'download.manualLink': 'Hier klicken zum manuellen Download',
    'download.smartscreen.title': 'Windows zeigt möglicherweise eine Warnung',
    'download.smartscreen.desc': 'Das ist bei neuer Open-Source-Software normal. So gehst du vor:',
