...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'meta.description.privacy': 'Privacy Policy for the WhisPaste desktop app: how it handles your data — offline by default, no account, no tracking, transcripts stay on your machine.',
    ...
    'explainer.privacy.seoDescription': 'How WhisPaste keeps voice input private: offline by default, direct-to-provider in cloud mode, no telemetry, no account, local history. Free & open source.',
  ...
  de: {
    ...
    'meta.description.privacy': 'Datenschutzerklärung für WhisPaste — wie Website und Desktop-App mit deinen Daten umgehen: offline als Standard, kein Tracking, kein Account.',
    ...
    'explainer.privacy.seoDescription': 'Wie WhisPaste Spracheingabe privat hält: offline als Standard, Direct-to-Provider im Cloud-Modus, keine Telemetrie, kein Account, lokaler Verlauf.',
