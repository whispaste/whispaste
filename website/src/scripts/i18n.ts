...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'workflowSelector.students.title': 'Students & researchers',
    'workflowSelector.students.desc': 'Speak notes, excerpts, and essay drafts instead of typing them, in your editor, Word, or Obsidian, without breaking your reading flow.',
    'workflowSelector.students.ariaLabel': 'WhisPaste for students and researchers, learn more',
  ...
  de: {
    ...
    'workflowSelector.students.title': 'Studierende & Forschende',
    'workflowSelector.students.desc': 'Notizen, Exzerpte und Hausarbeiten sprechen statt tippen, im Editor, in Word oder Obsidian, ohne den Lesefluss zu unterbrechen.',
    'workflowSelector.students.ariaLabel': 'WhisPaste für Studierende und Forschende, mehr erfahren',
