export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'faq.sysreq.a': 'Minimum: Windows 10 (64-bit) or macOS 10.15 Catalina+, 4\u202fGB RAM, ~500\u202fMB free disk space. No GPU required\u00a0— WhisPaste always falls back to CPU. Recommended: 8\u202fGB RAM, a dedicated GPU with 2\u2013\u20134\u202fGB VRAM (NVIDIA CUDA, AMD or Intel Vulkan). Larger models need more VRAM: the compact model needs ~300\u202fMB, the balanced model ~900\u202fMB, and the premium model ~2.6\u202fGB. The app automatically picks a safe model tier for your hardware.',
    ...
    'changelog.1.2.0.highlight.1': 'All dictation history stored locally in SQLite — no shared config files, no data loss',
    'changelog.1.2.0.highlight.2': 'New slim recording pill overlay with live waveform and progress indicator',
    'changelog.1.2.0.highlight.3': 'Always-on-top floating button for instant dictation from any app',
  ...
  de: {
    ...
    'faq.sysreq.a': 'Minimum: Windows\u00a010 (64-Bit) oder macOS\u00a010.15 Catalina+, 4\u202fGB RAM, ~500\u202fMB freier Speicher. Kein GPU nötig\u00a0— WhisPaste greift immer auf CPU zurück. Empfohlen: 8\u202fGB RAM, dedizierte GPU mit 2–4\u202fGB VRAM (NVIDIA CUDA, AMD oder Intel Vulkan). Größere Modelle brauchen mehr VRAM: das kompakte Modell ~300\u202fMB, das ausgewogene ~900\u202fMB, das Premium-Modell ~2,6\u202fGB. Die App wählt automatisch das passende Modell für deine Hardware.',
    ...
    'changelog.1.2.0.highlight.1': 'Gesamter Diktat-Verlauf lokal in SQLite gespeichert — keine geteilten Konfigdateien, kein Datenverlust',
    'changelog.1.2.0.highlight.2': 'Neue schlanke Aufnahme-Pille mit Live-Wellenform und Fortschrittsanzeige',
    'changelog.1.2.0.highlight.3': 'Schwebende Schaltfläche immer im Vordergrund für sofortiges Diktieren aus jeder App',
