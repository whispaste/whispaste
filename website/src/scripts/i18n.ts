export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'privacy.telemetry.desc': 'No analytics, no tracking. Optional crash reports help improve stability and can be turned off any time.',
    ...
    'faq.windows.a': 'Currently available for Windows. macOS and Linux versions are in active development. A mobile companion app is also planned.',
  ...
  de: {
    ...
    'privacy.telemetry.desc': 'Kein Tracking, keine Analytics. Optionale Crash-Reports helfen bei der Stabilität und lassen sich jederzeit abschalten.',
    ...
    'faq.windows.a': 'Aktuell für Windows verfügbar. macOS- und Linux-Versionen sind in aktiver Entwicklung. Eine mobile Begleit-App ist ebenfalls geplant.',
