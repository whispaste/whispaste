...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'explainer.privacy.tldr': 'WhisPaste is built to keep your voice private. Transcription runs 100% locally on your own device using bundled Whisper models — no cloud, no account, and no telemetry by default. Because it\'s open source, anyone can verify these claims in the code.',
  ...
  de: {
    ...
    'explainer.privacy.tldr': 'WhisPaste ist auf Privatsphäre ausgelegt. Die Transkription läuft zu 100 % lokal auf deinem Gerät mit mitgelieferten Whisper-Modellen — keine Cloud, kein Konto, standardmäßig keine Telemetrie. Weil es quelloffen ist, kann jeder diese Aussagen im Code überprüfen.',
