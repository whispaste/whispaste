...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'meta.description.download': 'Download WhisPaste for Windows and macOS — via Microsoft Store, DMG, or free on GitHub. Build from source on Linux. Offline-first voice input, no account, no subscription.',
  ...
  de: {
    ...
    'meta.description.download': 'WhisPaste für Windows und macOS herunterladen — über den Microsoft Store, als DMG oder kostenlos von GitHub. Unter Linux aus dem Quellcode bauen. Offline-first, ohne Account, ohne Abo.',
