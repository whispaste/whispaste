...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    'download.diagnose.step2.desc': 'On Windows double-click the .exe; on macOS open the .dmg and double-click WhisPaste-Diagnose.command. It writes a report to your Desktop.',
  ...
  de: {
    ...
    'download.diagnose.step2.desc': 'Unter Windows die .exe doppelklicken; unter macOS die .dmg öffnen und WhisPaste-Diagnose.command doppelklicken. Es legt einen Report auf dem Schreibtisch ab.',
