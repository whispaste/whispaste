...
- **Platforms:** Windows 10 (64-bit) and newer, macOS 11 Big Sur and newer (Apple Silicon). WhisPaste can also be downloaded for Ubuntu Linux (AppImage and .deb) directly from GitHub.
