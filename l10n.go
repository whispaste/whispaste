...
var translations = map[string]map[string]string{
	"en": {
		...
		"notebook.empty":        "No entries yet. Start dictating to build your notebook.",
	...
	"de": {
		...
		"notebook.empty":        "Noch keine Einträge. Starten Sie eine Diktierung, um Ihr Notizbuch zu füllen.",
